(function () { // Для того, чтобы код не был вызван
    const rm = new ResourceManager(() => { // callback, который будет вызван, когда все скачается
        ...
        const spriteList = gm.getSpriteList(
            ...
            true // Оптимизировать ли список по очередности текстур. По умолчанию false
        );
    ...
    }, 'load-list.json'); // путь до списка скачивания
});